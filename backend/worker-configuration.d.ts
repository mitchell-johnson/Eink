/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75051886ce13cb58562c0d0f1663bd38)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	IMAGES: R2Bucket;
	APP_ACCESS_TOKEN: string;
	OPENAI_API_KEY: string;
	JOBS: DurableObjectNamespace<import("./src/index").ImageJob>;
	ADMISSION: DurableObjectNamespace<import("./src/index").Admission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ImageJob" | "Admission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ACCESS_TOKEN" | "OPENAI_API_KEY">> {}
}
